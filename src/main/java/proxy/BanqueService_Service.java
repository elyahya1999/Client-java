 ...
 * 
 */
@WebServiceClient(name = "BanqueService", targetNamespace = "http://emsi5.ma/", wsdlLocation = "http://localhost:4415/BanqueService?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUESERVICE_QNAME = new QName("http://emsi5.ma/", "BanqueService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:4415/BanqueService?wsdl");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://emsi5.ma/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://emsi5.ma/", "BanqueServicePort"), BanqueService.class, features);
    }
