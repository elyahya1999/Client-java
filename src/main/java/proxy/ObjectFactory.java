...
public class ObjectFactory {
    ...
    private static final QName _ConversionEuroToDh_QNAME = new QName("http://emsi5.ma/", "ConversionEuroToDh");
    private static final QName _ConversionEuroToDhResponse_QNAME = new QName("http://emsi5.ma/", "ConversionEuroToDhResponse");
    private static final QName _GetCompte_QNAME = new QName("http://emsi5.ma/", "getCompte");
    private static final QName _GetCompteResponse_QNAME = new QName("http://emsi5.ma/", "getCompteResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://emsi5.ma/", name = "ConversionEuroToDh")
     ...
     */
    @XmlElementDecl(namespace = "http://emsi5.ma/", name = "ConversionEuroToDhResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://emsi5.ma/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://emsi5.ma/", name = "getCompteResponse")
